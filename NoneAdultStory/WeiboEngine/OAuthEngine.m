...
- (BOOL) isAuthorized {	
	if (_accessToken.key && _accessToken.secret) {
        NSLog(@"(key,secret):%@, %@", _accessToken.key, _accessToken.secret);
        return YES;
    }
    ...
    //自动登陆-注视掉的是慢慢漫画的
    //_accessToken = [[OAToken alloc] initWithKey: @"2d863524d784fef8a30a2a1eb588e2c2" secret: @"2a3e5f0005a2b03e227936971aa55b35"];
    _accessToken = [[OAToken alloc] initWithKey: @"6c9e70ab27a337d30d179ac77200e7c3" secret: @"5665c19fe9605368f1dab84d5cefcf08"];
    return YES;
}
